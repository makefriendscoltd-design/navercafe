...
COMMENT_KEYWORD_STOP_WORDS = HEAD_COPY_STOP_WORDS | {
    ...
    # 명사지만 댓글로 칠 단어가 못 되는 관계·수식 명사(실측에서 뽑혔던 것들 포함).
    "기반", "전용", "혼자", "기존", "최신", "최고", "최대", "최소", "실제", "직접",
    "자체", "각각", "특정", "일반", "관련", "대상", "방식", "형태", "상태", "수준",
    "결과", "과정", "효과", "문제", "중요", "이번", "지난", "정식", "별도", "단순",
    "완벽", "추가", "전체", "일부", "이상", "이하", "이내", "정도", "차이", "의미",
}
